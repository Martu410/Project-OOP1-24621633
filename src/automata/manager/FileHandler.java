...
public class FileHandler {
    ...
    // Метод за записване на всички автомати от мениджъра в избран текстов файл
    ...
    // Метод за четене на автомати от текстов файл и зареждането им обратно в мениджъра
