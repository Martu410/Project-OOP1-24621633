...
public class Automaton implements Recognizable {
    ...
    // Проверява дали езикът е празен (в базовата версия: проверява дали празната дума се разпознава)
    @Override
    public boolean isEmpty() {
        return !recognize(""); // Връща отрицание на това дали автоматът разпознава празен низ
    }
}